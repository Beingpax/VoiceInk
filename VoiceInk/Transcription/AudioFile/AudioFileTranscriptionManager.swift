...
class AudioTranscriptionManager: ObservableObject {
    ...
    func startProcessing(url: URL, modelContext: ModelContext, modelManager: ModelManager, enhancementService: AIEnhancementService?) {
        ...
        currentTask = Task {
            do {
                ...
                let serviceRegistry = TranscriptionServiceRegistry(modelManager: modelManager, modelsDirectory: modelManager.modelsDirectory, modelContext: modelContext)
                defer {
