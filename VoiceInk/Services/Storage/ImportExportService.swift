...
class ImportExportService {
    ...
    func exportSettings(enhancementService: AIEnhancementService, whisperPrompt: WhisperPrompt, hotkeyManager: HotkeyManager, menuBarManager: MenuBarManager, mediaController: MediaController, playbackController: PlaybackController, soundManager: SoundManager, modelContext: ModelContext) {
        ...
        let generalSettingsToExport = GeneralSettings(
            ...
            recorderType: UserDefaults.standard.string(forKey: keyRecorderType),
    ...
    @MainActor
    func importSettings(enhancementService: AIEnhancementService, whisperPrompt: WhisperPrompt, hotkeyManager: HotkeyManager, menuBarManager: MenuBarManager, mediaController: MediaController, playbackController: PlaybackController, soundManager: SoundManager, modelManager: ModelManager, modelContext: ModelContext) {
            ...
            if openPanel.runModal() == .OK {
                ...
                do {
                    ...
                    if let modelsToImport = importedSettings.customCloudModels {
                        ...
                        modelManager.refreshAllAvailableModels() // Refresh the UI
                    ...
                    if let general = importedSettings.generalSettings {
                        ...
                        if let recType = general.recorderType {
                            UserDefaults.standard.set(recType, forKey: self.keyRecorderType)
                        }
