...
class LastTranscriptionService: ObservableObject {
    ...
    static func retryLastTranscription(from modelContext: ModelContext, modelManager: ModelManager, enhancementService: AIEnhancementService?) {
        Task { @MainActor in
            ...
            guard let currentModel = modelManager.currentTranscriptionModel else {
                NotificationManager.shared.showNotification(
            ...
            let transcriptionService = AudioTranscriptionService(modelContext: modelContext, modelManager: modelManager, enhancementService: enhancementService)
            do {
