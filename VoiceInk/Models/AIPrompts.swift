enum AIPrompts {
    ...
    - <CURRENTLY_SELECTED_TEXT> may contain selected text from the user's current app.
    - <CLIPBOARD_CONTEXT> may contain text from the user's clipboard.
    - <CURRENT_WINDOW_CONTEXT> may contain text extracted from the active window.
    - <CUSTOM_VOCABULARY> may contain names, proper nouns, acronyms, and technical terms to spell exactly.
    ...
    - Use <CURRENTLY_SELECTED_TEXT>, <CLIPBOARD_CONTEXT>, and <CURRENT_WINDOW_CONTEXT> only to clarify spelling, references, formatting, or likely transcription errors.
    - Use <CUSTOM_VOCABULARY> to spell matching or similar-sounding terms exactly.
