...
class HistoryWindowController: NSObject, NSWindowDelegate {
    ...
    func showHistoryWindow(modelContainer: ModelContainer, enhancementService: AIEnhancementService) {
        ...
        let window = createHistoryWindow(modelContainer: modelContainer, enhancementService: enhancementService)
        historyWindow = window
        window.makeKeyAndOrderFront(nil)
        NSApplication.shared.activate(ignoringOtherApps: true)
    }

    private func createHistoryWindow(modelContainer: ModelContainer, enhancementService: AIEnhancementService) -> NSWindow {
