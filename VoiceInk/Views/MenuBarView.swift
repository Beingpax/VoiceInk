...
struct MenuBarView: View {
    ...
    var body: some View {
        VStack {
            ...
            Button(menuBarManager.isMenuBarIconHidden ? "Show Menu Bar Icon" : "Hide Menu Bar Icon") {
                menuBarManager.toggleMenuBarIconVisibility()
            }
            .disabled(!menuBarManager.isMenuBarOnly)
