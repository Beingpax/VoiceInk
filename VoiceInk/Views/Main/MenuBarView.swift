...
struct MenuBarView: View {
    ...
    var body: some View {
        VStack {
            ...
            Menu {
                ForEach(modelManager.usableModels, id: \.id) { model in
                    Button {
                        Task {
                        ...
                        HStack {
                            ...
                            if modelManager.currentTranscriptionModel?.id == model.id {
                ...
                HStack {
                    Text("Transcription Model: \(modelManager.currentTranscriptionModel?.displayName ?? "None")")
            ...
            LanguageSelectionView(modelManager: modelManager, displayMode: .menuItem, whisperPrompt: modelManager.whisperPrompt)
            ...
            Button("Retry Last Transcription") {
                LastTranscriptionService.retryLastTranscription(from: modelContext, modelManager: modelManager, enhancementService: enhancementService)
            }
            
            Button("Copy Last Transcription") {
                LastTranscriptionService.copyLastTranscription(from: modelContext)
            }
