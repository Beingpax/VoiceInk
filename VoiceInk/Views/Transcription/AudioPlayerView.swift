...
struct AudioPlayerView: View {
    ...
    private var transcriptionService: AudioTranscriptionService {
        AudioTranscriptionService(modelContext: modelContext, modelManager: modelManager, enhancementService: enhancementService)
    }
    ...
    private func retranscribeAudio() {
        guard let currentTranscriptionModel = modelManager.currentTranscriptionModel else {
