            ...
            VStack(spacing: 24) {
                ...
                SettingsSection(
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Toggle("Hide Menu Bar Icon", isOn: $menuBarManager.isMenuBarIconHidden)
                            .toggleStyle(.switch)
                            .disabled(!menuBarManager.isMenuBarOnly) // Only allow hiding menu bar icon in menu bar only mode
