...
My goal is to make it **the most efficient and privacy-focused voice-to-text solution for macOS** that is a joy to use. The source code is now open for experienced developers to build and contribute. Community support helps ensure continued development and access to upcoming features.
...
### Download
Get the latest version from [tryvoiceink.com](https://tryvoiceink.com). Community support helps me work on VoiceInk full-time and continuously improve it with new features and updates.
